...
class Effect(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.asteroidExpframes = Main.AST_EXP_SHEETS[0]
...
class Star(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image.fill(Config.Cfg.white)
        self.rect = self.image.get_rect()
    ...
    def createstarobjects(cls):
        ...
        for i in range(100):
            ...
            x_loc = random.randint(0, Config.Cfg.screen_width - 1)
            y_loc = random.randint(0, Config.Cfg.screen_height - 1)
            star = Star()
            star.rect.x = x_loc
            star.rect.y = y_loc
